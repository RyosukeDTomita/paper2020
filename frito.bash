...
psfile1="${path}${directry}${DAY}v.ps"
psfile2="${path}${directry}${DAY}t.ps"
psfile3="${path}${directry}${DAY}d.ps"
confile1="${path}${directry}${DAY}v.png"
confile2="${path}${directry}${DAY}t.png"
confile3="${path}${directry}${DAY}d.png"
infile="${path}${directry}BP222_${DAY}_00_00"
...
#
awk '{print $1,$2,$3}' $infile >$tmpfile1
...
##
gmt grdimage $grdfile2 -J$proj -Crb.cpt -B$frame -X13 -K -V > $psfile2
...
##
gmt grdimage $grdfile3 -J$proj -Crb.cpt -B$frame -X13 -K -V > $psfile3
